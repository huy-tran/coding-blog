...
use Modules\WebApp\View\Components\TallStackUI;
...
return [
    ...
    */
    'components' => [
        'alert' => TallStackUI\Alert::class,
        'avatar' => Components\Avatar::class,
        'badge' => TallStackUI\Badge::class,
        'banner' => Components\Banner::class,
        'boolean' => Components\Boolean::class,
        'button' => TallStackUI\Button::class,
        'button.circle' => TallStackUI\Circle::class,
